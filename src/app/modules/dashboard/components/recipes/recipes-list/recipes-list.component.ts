...
export class RecipesListComponent implements OnInit {
  ...
  recipes: Recipe[] = [
    {name: 'One Pot Thai-Style Rice Noodles', image_url: 'https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F3949345.jpg&w=272&h=272&c=sc&poi=face&q=85'
      , description: 'Chicken, vegetables, and noodles prepared in a light tasting but full-flavored Asian-inspired sauce.', userId: 'vreger', ingredients: [], is_private: true, rating: 4, id: '1'},
    {name: 'One Pot Thai-Style Rice Noodles', image_url: 'https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F3949345.jpg&w=272&h=272&c=sc&poi=face&q=85'
      , description: 'Chicken, vegetables, and noodles prepared in a light tasting but full-flavored Asian-inspired sauce.', userId: 'vreger', ingredients: [], is_private: true, rating: 5, id: '2'},
    {name: 'One Pot Thai-Style Rice Noodles', image_url: 'https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fimages.media-allrecipes.com%2Fuserphotos%2F3949345.jpg&w=272&h=272&c=sc&poi=face&q=85'
